import { Box, Button, ButtonGroup, Container, Heading, Highlight, HStack, IconButton, Text, useToast, VStack } from '@chakra-ui/react';
...
function BlogDetails() {
    ...
    return (
        <Box width="100vw">
            <BlogHeroImage />
            <BlogHeroHeader query={query} asPath={asPath} />
...
function BlogHeroHeader({ query, asPath }) {
    ...
    const handleCopytoClipCord = () => {

        const linkToCopy = `https://rockstarblogs${asPath}`
        ...
        <Container maxW="container.xl" my={8}>
            <HStack py={4} justifyContent="space-between">
                ...
                <ButtonGroup >
                    ...
                    <IconButton onClick={() => handleCopytoClipCord()} borderRadius="100" icon={<BsLink45Deg />} />
                </ButtonGroup>
            </HStack>
